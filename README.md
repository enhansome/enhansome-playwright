...
[Playwright](https://github.com/microsoft/playwright) ⭐ 96,679 | 🐛 180 | 🌐 TypeScript | 📅 2026-09-25 is a framework for Web Testing and Automation. It allows testing Chromium, Firefox and WebKit with a single API. Available for Node.js, Python, .NET and Java.
...
* [artillery-engine-playwright](https://github.com/artilleryio/artillery/tree/main/packages/artillery-engine-playwright) ⭐ 9,083 | 🐛 486 | 🌐 TypeScript | 📅 2026-09-23 - Load testing with Playwright.
* [CodeceptJS](https://github.com/Codeception/CodeceptJS) ⭐ 4,241 | 🐛 197 | 🌐 JavaScript | 📅 2026-09-25 - Supercharged End 2 End Testing Framework for Node.js.
...
* [playwright-bdd](https://github.com/vitalets/playwright-bdd) ⭐ 792 | 🐛 34 | 🌐 TypeScript | 📅 2026-09-07 - BDD testing with Playwright runner and CucumberJS.
...
* [playwright-pytest](https://github.com/microsoft/playwright-pytest/) ⭐ 564 | 🐛 25 | 🌐 Python | 📅 2026-09-09 - Official Pytest plugin for using Playwright pages with fixtures.
...
* [playwright-python](https://github.com/microsoft/playwright-python) ⭐ 15,017 | 🐛 18 | 🌐 Python | 📅 2026-09-24 - Official Playwright port to Python.
...
* [playwright-java](https://github.com/microsoft/playwright-java) ⭐ 1,553 | 🐛 37 | 🌐 Java | 📅 2026-09-16 - Official Playwright port to Java.
...
* [playwright-rust](https://github.com/padamson/playwright-rust) ⭐ 149 | 🐛 5 | 🌐 Rust | 📅 2026-09-25 - Playwright port for Rust.
...
* [playwright-skill](https://github.com/testdino-hq/playwright-skill) ⭐ 377 | 🐛 1 | 📅 2026-09-06 - 70+ production-tested Playwright skills for coding agents covering best practices, POM patterns, CI/CD, and migration paths.
...
* [CloakBrowser](https://github.com/CloakHQ/CloakBrowser) ⭐ 31,697 | 🐛 235 | 🌐 Python | 📅 2026-09-24 - Stealth Chromium with source-level fingerprint patches and a Playwright-compatible wrapper for Python and JavaScript.
* [Browserless](https://github.com/browserless/browserless) ⭐ 13,736 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-25 - Connects Playwright to remote managed browsers over WebSocket, with stealth and CAPTCHA handling.
* [camofox-browser](https://github.com/jo-inc/camofox-browser) ⭐ 11,224 | 🐛 114 | 🌐 JavaScript | 📅 2026-09-22 - Stealth headless browser server usable as a Playwright-compatible automation backend, with anti-detection built in.
* [invisible\_playwright](https://github.com/feder-cr/invisible_playwright) ⭐ 2,970 | 🐛 3 | 🌐 Python | 📅 2026-09-25 - Drop-in Playwright replacement using a patched Firefox with source-level fingerprint and anti-detection patches.
* [AntiBrow](https://github.com/antibrow/antibrow) ⭐ 771 | 🐛 145 | 🌐 TypeScript | 📅 2026-09-21 - Patched Chromium that returns a standard Playwright BrowserContext over CDP, with fingerprints applied in the C++ layer instead of injected scripts. MIT SDKs for Python and JavaScript, plus an MCP server mode.
* [Figranium](https://github.com/figranium/figranium) ⭐ 743 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-25 - Build complex browser workflows visually and execute them via API. Dockerized and Playwright-based.
...
* [Playwright MCP](https://github.com/microsoft/playwright-mcp) ⭐ 37,569 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-25 - Official Model Context Protocol server that gives LLMs browser automation via Playwright accessibility snapshots.
* [Webcmd](https://github.com/agentrhq/webcmd) ⭐ 2,559 | 🐛 48 | 🌐 TypeScript | 📅 2026-09-25 - CLI built on Playwright that learns a site's navigation once and compiles it into deterministic per-site commands for coding agents.
...
* [allure-playwright](https://github.com/allure-framework/allure-js/tree/master/packages/allure-playwright) ⭐ 281 | 🐛 68 | 🌐 TypeScript | 📅 2026-09-25 - Allure integration with Playwright Test framework.
...
* [Piwi](https://github.com/PiwiTests/platform) ⭐ 25 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-25 - Self-hosted Playwright dashboard with live run streaming, cross-project analytics, locator healing, flaky tracking, MCP server, and optional AI-assisted diagnosis.
...
* [VS Code](https://github.com/microsoft/vscode) ⭐ 192,924 | 🐛 21,154 | 🌐 TypeScript | 📅 2026-09-26 - Playwright is used to run cross-browser tests on their web builds.
* [TypeScript](https://github.com/microsoft/TypeScript) ⭐ 111,206 | 🐛 5,020 | 🌐 Go | 📅 2026-09-25 - Playwright is used to test TypeScript.js across browsers.
* [xterm.js](https://github.com/xtermjs/xterm.js) ⭐ 21,224 | 🐛 274 | 🌐 TypeScript | 📅 2026-09-13 - Playwright is used to run cross-browser integration tests.
...
Contributions welcome! Read the [contribution guidelines](https://github.com/mxschmitt/awesome-playwright/blob/main/CONTRIBUTING.md) ⭐ 1,583 | 🐛 11 | 📅 2026-09-20 first.
